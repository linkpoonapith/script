...
local CrucifixTool = game:GetObjects("rbxassetid://12282821227")[1]
CrucifixTool.Name = "Minecraft"
...
--         local CrucifixTool = game:GetObjects("rbxassetid://11719244659")[1]
...
local function func(ins)
    ...
    if ins:GetAttribute("IsCustomEntity")==true and ins:GetAttribute("ClonedByCrucifix")~=true then
        local Chains = game:GetObjects("rbxassetid://12282825920")[1]
...
dupeCrucifix.Event:Connect(function(time, entityRoot)
    local Cross = game:GetObjects("rbxassetid://12282946938")[1]
